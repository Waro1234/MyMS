    ...
    render() {
        ...
        return (
            <div className="prompts">{console.log(this.state.showButton)}
                <center><a style={{display: this.state.logged_in ? 'none' : 'block'}} onClick={this.openJoin} className="prompt-button">Register</a><br />
                <a style={{display: this.state.logged_in ? 'none' : 'block'}} onClick={this.openLogin} className="prompt-button">Login</a></center>
